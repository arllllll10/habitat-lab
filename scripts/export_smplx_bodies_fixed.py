...
### input is smplx parameters (stored in body_file)
### then smplx is converted to glb and fbx format
### then convert fbx to urdf format
...
def main():
    ...
    if args.body_file is None:
        ...
        with open(args.body_file):
            body_info = json.load(open(args.body_file, "r"))

    fbx_names = []
    export_glb = True
    export_urdf = True
    display = True  # TODO delete
    index_body = 0
    ...
    if export_urdf:
        for fbx_name in fbx_names:
            ...
            for obj in bpy.context.selected_objects:
                #obg:  <bpy_struct, Object("SMPLX-neutral") at 0x7fb65f4a0208>
